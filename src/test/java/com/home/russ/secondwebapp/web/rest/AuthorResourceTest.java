...
public class AuthorResourceTest {
    ...
    private static final String DEFAULT_AUTHOR_NAME = "SAMPLE_TEXT";
    private static final String UPDATED_AUTHOR_NAME = "UPDATED_TEXT";
    ...
    public void initTest() {
        author = new Author();
        author.setAuthor_name(DEFAULT_AUTHOR_NAME);
        author.setBirth_date(DEFAULT_BIRTH_DATE);
    }
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getAuthor_name()).isEqualTo(DEFAULT_AUTHOR_NAME);
        assertThat(testAuthor.getBirth_date()).isEqualTo(DEFAULT_BIRTH_DATE);
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        // Update the author
        author.setAuthor_name(UPDATED_AUTHOR_NAME);
        author.setBirth_date(UPDATED_BIRTH_DATE);
        ...
        Author testAuthor = authors.get(authors.size() - 1);
        assertThat(testAuthor.getAuthor_name()).isEqualTo(UPDATED_AUTHOR_NAME);
        assertThat(testAuthor.getBirth_date()).isEqualTo(UPDATED_BIRTH_DATE);
    }
